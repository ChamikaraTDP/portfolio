    ...
    <main className="">
      ...
      <section className="mt-16 flex justify-center">
        <div className="w-4/5 md:w-3/5 text-center">
          ...
          <p className="sm:text-center lg:text-left text-lg mt-5">
            While back in university I used to participate in hackathons and coding competitions. By
            doing so I was able to meet professionals from the software industry. It&apos;s from
            them that I learned that I have to learn more than what It&apos;s being taught in the
            university if I am about to be a successful software developer. So I learned much
            outside of the university curriculum spending every bit of spare time I had. When I
            joined DFAR (IT division, Department of Fisheries and Aquatic Resources) for training
            they asked me to create an inventory system to replace their handwritten ledgers. I was
            able to create a working system. Finally after many unsuccessful projects this was my
            first successful venture. After the training, while continuing the studies, I started to
            give side support for a freelancer. I learned much about freelancing from him. After
            graduating I worked full time for a few companies until I decided to start working as a
            freelancer. <br /> <br /> I like to talk with clients, understand their businesses and
            be involved as it is my own. I also enjoy learning new tools and technologies and
            understand what problems they solve and for what specific use case they are good at. So
            that I can leverage them as it fits best. So here I am. <br /> <br />
        ...
        <div className="mt-16 w-4/5 md:w-3/5 flex justify-between">
          <div>
            <div className="h-[143px]">
              <Image src="/icons/react.svg" width={143} height={143} alt="react icon" />
            </div>
          ...
          <div>
            <div className="h-[143px]">
              <Image src="/icons/nestjs.svg" width={143} height={143} alt="react icon" />
            </div>
          ...
          <div>
            <div className="h-[143px]">
              <Image src="/icons/nextjs.svg" width={143} height={143} alt="react icon" />
            </div>
          ...
          <div>
            <div className="h-[143px]">
              <Image src="/icons/postgresql.png" width={143} height={143} alt="react icon" />
            </div>
          ...
          <div>
            <div className="h-[143px]">
              <Image src="/icons/laravel.svg" width={143} height={143} alt="react icon" />
            </div>
      ...
      <section className="mt-14 text-center">
        <h3 className="text-xl md:text-2xl font-semibold text-title-primary mt-5">
          Other than the main stack listed above I&apos;m well versed in following tools
        </h3>
      ...
      <section className="mt-20 py-20 text-center bg-white">
        ...
        <div className="">
          <div className="mx-auto pl-4 w-4/5 md:w-3/5">
            <div className=" mt-10">
              <div className="text-2xl">Bachelor of Science in Computer Science (2017-2021)</div>
              <div className="text-lg">at University of Jaffna, Sri Lanka</div>
            </div>

            <div className=" mt-10">
              <div className="text-2xl">Algorithms on Graphs (Certificate Course)</div>
              <div className="text-lg">at University of California San Diego, Coursera</div>
            </div>
      ...
      <section className="mt-20 py-20 text-center">
        <h3 className="text-xl font-semibold text-gray-600 mx-auto pl-4 w-4/5 md:w-3/5 lg:w-1/2">
          I post technical content on my blog and share useful stuff on twitter. Please check them
          out If you’re interested. Thanks!
        </h3>
      </section>
    </main>
  );
